...
# Title: Monitoring Spektrum Frekuensi dengan Hack RF
# Author: raspi4b
...
class hakrf_single_frequency(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Monitoring Spektrum Frekuensi dengan Hack RF", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Monitoring Spektrum Frekuensi dengan Hack RF")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hakrf_single_frequency")
        ...
        self.center_frek = center_frek = 100e6
        ...
        self._center_frek_tool_bar = Qt.QToolBar(self)
        self._center_frek_tool_bar.addWidget(Qt.QLabel("Frekuensi" + ": "))
        self._center_frek_line_edit = Qt.QLineEdit(str(self.center_frek))
        self._center_frek_tool_bar.addWidget(self._center_frek_line_edit)
        self._center_frek_line_edit.returnPressed.connect(
            lambda: self.set_center_frek(eng_notation.str_to_num(str(self._center_frek_line_edit.text()))))
        self.top_grid_layout.addWidget(self._center_frek_tool_bar, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.osmosdr_source_0.set_center_freq(center_frek, 0)
        self.osmosdr_source_0.set_freq_corr(((1.4e6 / center_frek) * 1e6), 0)
    ...
    def get_center_frek(self):
        return self.center_frek

    def set_center_frek(self, center_frek):
        self.center_frek = center_frek
        Qt.QMetaObject.invokeMethod(self._center_frek_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.center_frek)))
        self.osmosdr_source_0.set_center_freq(self.center_frek, 0)
        self.osmosdr_source_0.set_freq_corr(((1.4e6 / self.center_frek) * 1e6), 0)
        self.qtgui_freq_sink_x_1.set_frequency_range(self.center_frek, 21e6)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.center_frek, 21e6)
...
def main(top_block_cls=hakrf_single_frequency, options=None):
