...
class RTL_SDR_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "RTL_SDR_rcv")
        ...
        self._volume_range = qtgui.Range(0, 1.0, 0.05, 0.2, 200)
        ...
        self._freq_range = qtgui.Range(87.9e6, 107.9e6, 50e3, 102.1e6, 200)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_wavfile_sink_0, 1))
