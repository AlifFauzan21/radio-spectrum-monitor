...
- name: blocks_multiply_const_vxx_1
  ...
  parameters:
    ...
    alias: ''
    comment: ''
    const: 1.0 if run_control else 0.0
    maxoutbuf: '0'
    minoutbuf: '0'
    type: complex
    vlen: '1'
...
- name: qtgui_freq_sink_x_1
  ...
  parameters:
    ...
    maxoutbuf: '0'
    minoutbuf: '0'
    name: Sinyal Setelah Mixing (Monitoring hasil translasi ke baseband)
    nconnections: '1'
    norm_window: 'False'
    showports: 'False'
    tr_chan: '0'
...
- [analog_wfm_rcv_0, '0', blocks_multiply_const_vxx_3, '0']
- [blocks_multiply_const_vxx_0, '0', audio_sink_0, '0']
- [blocks_multiply_const_vxx_1, '0', qtgui_waterfall_sink_x_0, '0']
- [blocks_multiply_const_vxx_2, '0', qtgui_freq_sink_x_1, '0']
- [blocks_multiply_const_vxx_3, '0', blocks_multiply_const_vxx_0, '0']
...
- [osmosdr_source_0, '0', blocks_multiply_const_vxx_1, '0']
